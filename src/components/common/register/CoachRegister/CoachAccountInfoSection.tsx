...
interface CoachAccountInfoSectionProps {
  formData: CoachRegisterRequest
  onInputChange: (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => void
}

const CoachAccountInfoSection: React.FC<CoachAccountInfoSectionProps> = ({ formData, onInputChange }) => {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="group">
          ...
          <div className="relative">
            ...
            />
            <FiMail className="absolute left-4 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 group-focus-within:text-blue-500 transition-colors duration-300" />
          </div>
        </div>
        ...
        <div className="group">
          ...
          <div className="relative">
            ...
            />
            <FiLock className="absolute left-4 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 group-focus-within:text-blue-500 transition-colors duration-300" />
          </div>
        </div>
        ...
        <div className="md:col-span-2 group">
          ...
          <div className="relative">
            ...
            />
            <FiPhone className="absolute left-4 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 group-focus-within:text-blue-500 transition-colors duration-300" />
          </div>
        </div>
      </div>
    </div>
...
export default CoachAccountInfoSection
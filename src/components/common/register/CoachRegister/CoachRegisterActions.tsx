      ...
      <button
        ...
        className={`group relative overflow-hidden px-12 py-4 rounded-2xl text-lg font-bold transition-all duration-500 transform shadow-2xl ${
          isLoading
            ...
            : 'bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white hover:scale-[1.02] hover:shadow-3xl'
        }`}
      >
        {!isLoading && (

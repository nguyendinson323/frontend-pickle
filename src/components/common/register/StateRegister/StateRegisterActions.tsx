  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="bg-red-600 hover:bg-red-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white px-12 py-3 rounded-lg text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg"
      >
        {isLoading ? (
          <div className="flex items-center">
            ...
            Creating State Committee Account...
          </div>
        ) : (

    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div className="text-center p-4 bg-gray-50 rounded-lg">
          ...
          <p className="text-2xl font-bold text-green-600">+{partnerData.stats.revenue_growth || 0}%</p>
        ...
        <div className="text-center p-4 bg-gray-50 rounded-lg">
          ...
          <p className="text-2xl font-bold text-blue-600">+{partnerData.stats.booking_trend || 0}%</p>

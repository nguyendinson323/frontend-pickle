...
const EditTournamentModal: React.FC<EditTournamentModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 overflow-y-auto h-full w-full z-50 flex items-start justify-center p-4">
      <div className="relative w-full max-w-5xl bg-gradient-to-br from-white to-blue-50 border border-blue-200 rounded-3xl shadow-2xl my-8">
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white px-8 py-6 rounded-t-3xl">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-100 font-medium mt-1">Update your tournament details and settings</p>
            </div>
            <button
              onClick={onClose}

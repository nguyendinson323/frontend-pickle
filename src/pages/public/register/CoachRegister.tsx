...
const CoachRegister: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // API call
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/register/coach`, {
        method: 'POST',
        headers: {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Join the Mexican Pickleball Federation as a certified coach</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              <h3 className="text-lg font-medium text-green-800 mb-2">Coach Benefits</h3>
              <ul className="text-sm text-green-700 space-y-1">
                <li>• Access to coaching certification programs</li>
                <li>• Ability to list coaching services on the platform</li>
                <li>• Access to student management tools</li>
                <li>• Professional development opportunities</li>
                <li>• Tournament referee opportunities</li>
              </ul>
            </div>

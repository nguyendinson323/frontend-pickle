...
const PartnerRegister: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // API call
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/register/partner`, {
        method: 'POST',
        headers: {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Partner with the Mexican Pickleball Federation to support the sport</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-orange-50 p-4 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                />
                <label htmlFor="has_courts" className="ml-2 text-sm font-medium text-orange-900">
                  We have courts available for rental
                </label>
              </div>
              
              {formData.has_courts && (
                <div className="mt-3 p-3 bg-orange-100 rounded">
                  <h4 className="text-sm font-medium text-orange-800 mb-2">Premium Partner Benefits:</h4>
                  <ul className="text-sm text-orange-700 space-y-1">
                    <li>• Register courts for public booking and revenue generation</li>
                    <li>• Create and manage tournaments on the platform</li>
                    <li>• Access to advanced analytics and reporting</li>
                    <li>• Priority placement in partner directory</li>
            ...
            <div>
              ...
              <FileUpload
                ...
                helpText="Upload your business logo in PNG, JPG, or JPEG format"
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <h3 className="text-lg font-medium text-blue-800 mb-2">Partnership Benefits</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <ul className="text-sm text-blue-700 space-y-1">
                  <li>• No affiliation fees for partners</li>
                  <li>• Revenue opportunities through court rentals</li>
                  <li>• Tournament hosting and management</li>
                  <li>• Brand exposure to pickleball community</li>
                </ul>
                <ul className="text-sm text-blue-700 space-y-1">
                  <li>• Professional networking opportunities</li>
                  <li>• Marketing support from federation</li>
                  <li>• Access to player database for events</li>
                  <li>• Partnership certificate and recognition</li>
                </ul>
              </div>
            </div>
            ...
            <div className="pt-6">
              ...
              >
                {isSubmitting ? 'Registering...' : 'Become Partner'}
              </button>
            </div>
          </form>
        </div>
